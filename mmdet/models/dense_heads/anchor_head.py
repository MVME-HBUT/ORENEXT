...
class AnchorHead(BaseDenseHead, BBoxTestMixin):
    ...
    def forward_single(self, x):
        ...
        # print(cls_score[0].shape,cls_score[1].shape)
    ...
    def _get_targets_single(self,
        ...
        # print('type(inside_flags) = ', type(inside_flags), '\n inside_flags.shape = ', inside_flags.shape, '\n flat_anchors.shape = ', flat_anchors.shape)
    ...
    def get_targets(self,
        ...
        # print('all_labels[0].shape = ',all_labels[0].shape,'all_labels[1].shape = ', all_labels[1].shape)
        # print('=============================')
