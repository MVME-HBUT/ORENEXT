...
def main(args):
    ...
    for imgId in tqdm.tqdm(imgIds, ncols=100):
        ...
        if len(annIds) > 0:
            ...
            img_origin_path = os.path.join(args.input_dir, 'stones', args.split, img['file_name'])
...
def get_args():
    ...
    parser.add_argument("--input_dir", default="/home/yzhang/AS-MLP-Object-Detection/data/coco", type=str,
